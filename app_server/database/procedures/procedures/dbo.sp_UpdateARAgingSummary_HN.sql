...
create PROCEDURE [dbo].[sp_UpdateARAgingSummary_HN]
AS
BEGIN
    SET NOCOUNT ON;
    ...
    LEFT JOIN [OMEGA_TEST].[dbo].[IT1202] AS T_KH ON T_Bal.ObjectID = T_KH.ObjectID
    ...
    TRUNCATE TABLE dbo.CRM_AR_AGING_SUMMARY_HN;

    INSERT INTO dbo.CRM_AR_AGING_SUMMARY_HN (
