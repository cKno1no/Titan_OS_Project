CREATE PROCEDURE dbo.sp_CalculateAllSalesVelocity
AS
BEGIN
SET NOCOUNT ON;
    ...
    TRUNCATE TABLE dbo.VELOCITY_SKU_CUSTOMER;
    TRUNCATE TABLE dbo.VELOCITY_SKU_GROUP;
    ...
    WITH SalesHistory AS (
        ...
        FROM 
            [OMEGA_STDD].[dbo].[GT9000] AS G
        JOIN 
            [OMEGA_STDD].[dbo].[IT1302] AS I ON G.InventoryID = I.InventoryID
        WHERE 
    ...
    INSERT INTO dbo.VELOCITY_SKU_CUSTOMER (
        Varchar05, 
        ObjectID, 
        Flag, 
    ...
    INSERT INTO dbo.VELOCITY_SKU_GROUP (
        Varchar05, 
    ...
    FROM 
        dbo.VELOCITY_SKU_CUSTOMER AS V
    JOIN 
        [OMEGA_STDD].[dbo].[IT1302] AS I ON V.Varchar05 = I.Varchar05
    WHERE 
